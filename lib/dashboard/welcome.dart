...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const  Text('Food Panda App') ,
        actions: const[
                            ...
                            child: const Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Up to 50% off' , style: TextStyle(color: blackColor , fontWeight: FontWeight.w500 ,height:1 , fontFamily: Medium, fontSize: 14  )),
                            ...
                            child: const Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Everyday essentials' ,style: TextStyle(color: blackColor , fontWeight: FontWeight.w500 , fontFamily: Medium, fontSize: 14  )),
